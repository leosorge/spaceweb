...
# ============================================================
# SCHERMATA QUIZ — stile Portafoglio con card
# ============================================================
def schermata_quiz():
    ss = st.session_state
    ...
    if ss.quiz_tipo is None:
        ...
        <h2 class="white-text">🎓 QUIZ COSMICO</h2>
        """, unsafe_allow_html=True)
        ...
        for i, (q_id, info) in enumerate(quiz_info.items()):
            with cols[i % 3]:
                ...
                if q_id > 6:
                    ...
                    """, unsafe_allow_html=True)
                    # Bottone Streamlit per avviare il quiz — sotto la card
